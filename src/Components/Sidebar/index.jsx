...
import { faB, faBell, faEllipsisH, faEnvelope, faHashtag, faHome, faUserFriends } from "@fortawesome/free-solid-svg-icons"
import { faUser } from "@fortawesome/free-solid-svg-icons/faUser"
import { faBookmark } from "@fortawesome/free-solid-svg-icons/faBookmark"
import { faFeatherAlt } from "@fortawesome/free-solid-svg-icons/faFeatherAlt"

const NavItem = ({icon,text}) => (
<div className="flex item-center p-3 rounded-full cursor-pointer hover:bg-gray-600 transition duration-200">
